...
#when looking at cantons with all the same size
# w <- rep(1,k)
#multiplication factor to have the same mean vacc cov as weighted mean and have all cantons with same size
# fp <- 0.5163386/0.4815385
